            ...
            <div class="col s12">
                ...
                <center>
                    ...
                    <button class="btn waves-effect waves-light" type="submit" name="action">Companies
                          ...
                          <button class="btn waves-effect waves-light" type="submit" name="action">Customers
                                <i class="material-icons right">send</i>
                              </button>
                          </form>
                                                                              <br>
                          ...
                          <button class="btn waves-effect waves-light" type="submit" name="action">Place an order
                                <i class="material-icons right">send</i>
                              </button>
                          </form>
                </center>
